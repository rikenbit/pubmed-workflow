...
import_file_name = "data/pubmed/pmc.txt"
cell_separator = "|||"
lines = []
insert_query = "INSERT INTO pmc (pmid, pmcid) VALUES (?, ?);"
db_connection = sqlite3.connect("sqlite/pmc.sqlite")
db_cursor = db_connection.cursor()
db_cursor.execute("CREATE TABLE pmc (pmid INTEGER, pmcid TEXT);")
